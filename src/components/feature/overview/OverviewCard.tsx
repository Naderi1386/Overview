const OverviewCard = ({ label, value }: { label: string; value: string }) => {
  return (
    <div className="w-36 text-center bg-gradient-to-br from-[#282828] to-[#121111] border border-white/10 rounded-xl p-2.5 hover:shadow-lg transition-all duration-200">
